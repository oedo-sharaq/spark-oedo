...
spark_oedo_help() {
    ...
    echo "  ridf_parquet_processor.py      - Process Parquet with block data and extract events"
    ...
    echo ""
    echo "Examples:"
    echo "  ridf_to_parquet.py input.ridf output.parquet"
    echo "  ridf_parquet_processor.py input.parquet output_segdata.parquet"
    echo ""
    ...
    echo "  ridf_parquet_processor.py --help"
}
